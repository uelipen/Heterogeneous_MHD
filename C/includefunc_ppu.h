...
void define_value_matrix4D(float *dv4_ub, int dv4_nub, int *dv4_nx, int *dv4_ny, int *dv4_nz, float dv4_value)
{
...
void define_value_matrix3D(float *dv3_ub, int dv3_nub, int *dv3_nx, int *dv3_ny, int *dv3_nz, float dv3_value, int dv3_index)
{
...
void define_value_M2M_matrix4D(float *dvM2M4_ubL, float *dvM2M4_ubR, int dvM2M4_nubL, int dvM2M4_nubR, int dvM2M4_iiL, int dvM2M4_iiR, int *dvM2M4_nx, int *dvM2M4_ny, int *dvM2M4_nz, float dvM2M4_times)
{
